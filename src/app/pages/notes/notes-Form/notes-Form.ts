  ...
  createNote(id: number){
    ...
    if (this.editando()) {
      ...
      if (!this.rivalId()) {
          ...
          this.notesService.editRosterNote(this.noteId, body).subscribe({
              ...
              next: () => {
                  ...
                  Swal.fire({
                    icon: 'success',
                    title: 'nota editada!',
                    text: 'La nota de personaje se edito correctamente.',
          ...
          this.notesService.editMatchNote(this.noteId, body).subscribe({
           ...
           next: () => {
                  ...
                  Swal.fire({
                    icon: 'success',
                    title: '¡Nota editada!',
                    text: 'LA nota del enfrentamiento se edito correctamente.',
                    confirmButtonText: 'Aceptar'
                  }).then((result) => {
     ...
     if (!this.rivalId()) {
          ...
          this.notesService.registerRosterNotes(body, this.rosterId).subscribe({
          ...
          this.notesService.registerMatchNotes(body, this.rosterId, this.rivalId()!).subscribe({
